...
<aside id="side-overlay">
    ...
    <div class="content-header border-bottom">
        ...
        <a class="img-link mr-1" href="javascript:void(0)">
            <img class="img-avatar img-avatar32" src="{{ asset('dashboard/assets/media/avatars/avatar10.jpg') }}"
                alt="">
        </a>
        <!-- END User Avatar -->
                            ...
                            <ul class="nav-items mb-0">
                                    ...
                                    <a class="media py-2" href="javascript:void(0)">
                                        <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                            <img class="img-avatar img-avatar48"
                                                src="{{ asset('dashboard/assets/media/avatars/avatar6.jpg') }}"
                                                alt="">
                                            <span
                                ...
                                <li>
                                    <a class="media py-2" href="javascript:void(0)">
                                        <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                            <img class="img-avatar img-avatar48"
                                                src="{{ asset('dashboard/assets/media/avatars/avatar9.jpg') }}"
                                                alt="">
                                            <span
                                                class="overlay-item item item-tiny item-circle border border-2x border-white bg-success"></span>
                                        </div>
                                ...
                                <li>
                                    <a class="media py-2" href="javascript:void(0)">
                                        <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                            <img class="img-avatar img-avatar48"
                                                src="{{ asset('dashboard/assets/media/avatars/avatar2.jpg') }}"
                                                alt="">
                                            <span
                                                class="overlay-item item item-tiny item-circle border border-2x border-white bg-success"></span>
                                        </div>
                                ...
                                <li>
                                    <a class="media py-2" href="javascript:void(0)">
                                        <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                            <img class="img-avatar img-avatar48"
                                                src="{{ asset('dashboard/assets/media/avatars/avatar4.jpg') }}"
                                                alt="">
                                            <span
                                ...
                                <li>
                                    <a class="media py-2" href="javascript:void(0)">
                                        <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                            <img class="img-avatar img-avatar48"
                                                src="{{ asset('dashboard/assets/media/avatars/avatar16.jpg') }}"
                                                alt="">
                                            <span
                                                class="overlay-item item item-tiny item-circle border border-2x border-white bg-warning"></span>
                                        </div>
