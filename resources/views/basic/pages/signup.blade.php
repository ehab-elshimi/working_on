                    ...
                    <div class="block block-rounded block-themed mb-0">
                        <div class="block-header bg-primary-dark">
                            ...
                            <div class="block-options">
                                ...
                                <a class="btn-block-option" href="{{ route('dashboard.auth.login') }}" data-toggle="tooltip"
                                    ...
                                    <div class="py-3">
                                        <div class="form-group">
                                            <input type="text"
                                                ...
                                                id="signup-username" name="name" placeholder="{{ __('Name') }}"
                                        ...
                                        <div class="form-group">
                                            <input type="email"
                                                ...
                                                value="{{ old('email') }}" required autocomplete="email" id="signup-email"
